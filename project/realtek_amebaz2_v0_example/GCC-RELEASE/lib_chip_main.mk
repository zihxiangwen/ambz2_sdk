...
SRC_CPP += $(CHIPDIR)/src/app/clusters/door-lock-server/door-lock-server-core.cpp
SRC_CPP += $(CHIPDIR)/src/app/clusters/door-lock-server/door-lock-server-logging.cpp
SRC_CPP += $(CHIPDIR)/src/app/clusters/door-lock-server/door-lock-server-schedule.cpp
SRC_CPP += $(CHIPDIR)/src/app/clusters/door-lock-server/door-lock-server-user.cpp
